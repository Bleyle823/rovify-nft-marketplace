...
export interface SE2NFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface SE2NFT extends BaseContract {
  connect(runner?: ContractRunner | null): SE2NFT;
  waitForDeployment(): Promise<this>;

  interface: SE2NFTInterface;
  ...
  mintItem: TypedContractMethod<[to: AddressLike], [bigint], "nonpayable">;
  ...
  uris: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
